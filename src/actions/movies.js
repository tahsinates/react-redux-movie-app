...
export function fetchMovies(){
    return dispatch => {
        dispatch({
                type: "FETCH_MOVIES",  // redux-promise-middleware yardimi ile yukardaki const degiskenlerin atamasi yapildi -> FETCH_MOVIES_XXXXX
...
export function deleteMovie(id){
    return dispatch => {
        dispatch({
                type: "DELETE_MOVIE",  // redux-promise-middleware yardimi ile yukardaki const degiskenlerin atamasi yapildi -> FETCH_MOVIES_XXXXX
